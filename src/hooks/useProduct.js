...
export default function useProduct(product, productID) {
    ...
    const productThumbnailImage = product?.image || product?.image1 ? (
        <Image
    ...
    const productThumbnailImageCart = product?.image || product?.image1 ? (
        <Image
            src={product.image?product.image:product.image1}
            alt={product.title}
            layout="responsive"
    ...
    return {
        ...
        thumbnailImageCart: productThumbnailImageCart,
        price: productPrice,
